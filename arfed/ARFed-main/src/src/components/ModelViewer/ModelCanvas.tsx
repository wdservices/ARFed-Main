    ...
    <div className="relative flex-1 bg-white rounded-2xl overflow-hidden animate-fade-in h-[calc(100vh-180px)]"
      ...
      <Canvas
        ...
        onCreated={({ scene, gl }) => {
          ...
          scene.environment = null;
          scene.background = new THREE.Color('#101014'); // Use '#f4f4f7' for a light look
          gl.toneMapping = THREE.NoToneMapping;
          gl.toneMappingExposure = 1;
          gl.shadowMap.enabled = true;
          gl.shadowMap.type = THREE.PCFSoftShadowMap;
      ...
      >
        ...
        <ambientLight intensity={lightingIntensity} color="#9ca3af" />
        <directionalLight 
          position={[10, 10, 5]} 
          intensity={lightingIntensity * 1.1} 
          color="#d1d5db"
          castShadow
        ...
        <pointLight 
          position={[5, 5, 5]} 
          intensity={lightingIntensity * 0.5} 
          color="#d1d5db"
          castShadow
          shadow-mapSize-width={1024}
          shadow-mapSize-height={1024}
        ...
        <pointLight 
          position={[-5, -5, -5]} 
          intensity={lightingIntensity * 0.3} 
          color="#d1d5db"
          castShadow
          shadow-mapSize-width={1024}
          shadow-mapSize-height={1024}
